...
public class Message extends JsonMarker {
     ...
     */
    public Message(@Nullable String to, @Nullable String body) {
        this.to = to;
        this.message = body;
    }
     ...
     * <p>Will be null if the message is for a one-to-one conversation. In that case use {@link #getTo()}.</p>
     */
    public @Nullable String getClientGroupId() {
     ...
     * <p>For one-to-one conversations, ignore this and see {@link #setTo(String)} instead.</p>
     */
    public void setClientGroupId(@Nullable String clientGroupId) {
     ...
     *
     * @see ApplozicConversation#markAsRead(Context, String, String, Integer)
     */
    public @NonNull Boolean isRead() {
     ...
     *
     * <p>A downloaded attachment will return a non-null/non-empty {@link #getFilePaths() local file path}.</p>
     */
    ...
    /**
     * Timestamp (in milliseconds) at which the message was <i>send</i> call to the server was done.
     */
    public @Nullable Long getCreatedAtTime() {
    ...
    public @NonNull Boolean getDelivered() {
    ...
    public boolean isSentToMany() {
        return !TextUtils.isEmpty(getTo()) && getTo() != null && getTo().split(",").length > 1;
    }

    /**
     * An outbox message is one that is <i>sent</i>.
     */
     ...
     * @see FileMeta
     */
    public @Nullable FileMeta getFileMetas() {
        return fileMeta;
    }
     ...
     */
    public @Nullable String getMetaDataValueForKey(@NonNull String key) {
     ...
     */
    public @NonNull List<String> getSenderIdListFor() {
        if (getTo() != null && !TextUtils.isEmpty(getTo())) {
    ...
    public enum ContentType {
        ...
        /**
         * When the message has a contact vcf file attached to it.
         */
